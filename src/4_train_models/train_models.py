...
save_model(booru_path("models/linear_regression.p"), regr)
...
# regr.fit(X_train, y_train)
# print("[{}] training complete".format(timestamp()))
# save_model(booru_path("models/decision_tree.p"), regr)

regr = load_model(booru_path("models/decision_tree.p"))
...
# print("predictions:",regr.predict(X_test))
print("mean_absolute_error:", mean_absolute_error(y_test, regr.predict(X_test)))
save_model(booru_path("models/regression_forest.p"), regr)
